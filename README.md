...
You should define your custom Juiced variables above the `@import statement` as this will allow your updated variables to be used even after updating Juiced using `bower update`.  *See /sass/_variables.scss for a list of available variables.*
